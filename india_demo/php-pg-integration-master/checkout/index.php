    ...
    <div class="container fluid">
      ...
      <form id="redirectForm" method="post" action="request.php">
        <div class="form-group">
          <label></label><br>
          <input type="hidden" class="form-control" name="appId" placeholder="Enter App ID here (Ex. 123456a7890bc123defg4567)" value="132572fe883248a8ea7b6e5918275231"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label></label><br>
          <input type="hidden" class="form-control" name="returnUrl" placeholder="Enter the URL to which customer will be redirected (Ex. www.example.com)" value="http://localhost/demoo/india_demo/php-pg-integration-master/checkout/sucsses_responce.php"/>
        </div>        
        <div class="form-group">
          <label></label><br>
          <input type="hidden" class="form-control" name="notifyUrl" placeholder="Enter the URL to get server notificaitons (Ex. www.example.com)" value="http://localhost/demoo/india_demo/php-pg-integration-master/checkout/index.php"/>
        </div>
